...
export const verhaal = {
  ...
  type_voorstelling:
    "De legende van Roloc is een typische Bank Vooruit-voorstelling. Live muziek, zang en dans begeleiden een verhaal vol humor en avontuur. De kinderen lossen samen met de acteurs het mysterie op en zorgen zo voor de grote redding! Plezier gegarandeerd vanaf 6 jaar.",
  // terugblik:
