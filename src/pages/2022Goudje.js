...
export default function Goudje2022() {
  return (
    <Project {...projectGegevens}>
      <img
        src={`%PUBLIC_URL%/afbeeldingen/${projectGegevens.voorstelling_id}/promomateriaal/Maan-donker-trans-Goudje.png`}
        alt="Maan met naald en draad errond"
        className="pt-4 h-96 w-96 mx-auto"
      />
      <img
        src={`%PUBLIC_URL%/afbeeldingen/${projectGegevens.voorstelling_id}/promomateriaal/Website_TitelGoudje_Transparant_cropped.png`}
